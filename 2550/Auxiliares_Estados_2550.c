...
void GrafFrame(){
   drawHLine(        19, (_height-14),(_width-27),TX_COLOR);
   drawVLine(        21,           20,(_height-29),TX_COLOR);
   drawHLine(        19,           20,           5,TX_COLOR);
   drawVLine((_width-10),(_height-16),          5,TX_COLOR);
   return;
}
...
void printVacio(){
   ...
   fillRect(22,21,(_width-30),(_height-35),BG_COLOR);
   tft_gotoxy(0, 2);
   printf(tft_putc,"  \n   ");
   tft_gotoxy(X_MAX-6, Y_MAX);
   printf(tft_putc,"TTTTT");
   tft_gotoxy(11,8);
   switch(config&0x03){
      case 0:
