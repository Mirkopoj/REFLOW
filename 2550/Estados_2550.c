...
#include "Auxiliares_Estados_2550.c"
//Funciones de estado
...
int Perfiles(int *nPuntos,struct Punto *Curva){
   ...
   while(1){
      ...
      if(ultimaTecla==_TICK){
         ...
         switch(config&0x03){
            case 0:
               printf(tft_putc,"PERFIL");
               break;
            case 1:
               printf(tft_putc,"PROFILE");
               break;
            case 2:
               printf(tft_putc,"PROFIL");
               break;
            case 3:
         ...
         if(perfilVacio(nPerfil)){
            ...
            switch(config&0x03){
               case 0:
                  ...
                  break;
               case 1:
                  printf(tft_putc,"CREATE");
                  break;
               case 2:
                  printf(tft_putc,"CRÉER");
                  break;
               case 3:
                  printf(tft_putc,"CO[ÄABATÜ");
                  break;
            }
            ...
            *nPuntos=1;
            ...
            switch(config&0x03){
               case 0:
                  printf(tft_putc,"CARGAR");
                  break;
               case 1:
                  printf(tft_putc,"LOAD");
                  break;
               case 2:
                  printf(tft_putc,"CHARGER");
                  break;
               case 3:
                  printf(tft_putc,"HAÃPY[KA");
                  break;
            }
            printEspacios(2);
            switch(config&0x03){
               case 0:
                  printf(tft_putc,"EDITAR");
                  break;
               case 1:
                  printf(tft_putc,"EDIT");
                  break;
               case 2:
                  printf(tft_putc,"ÉDITER");
                  break;
               case 3:
                  printf(tft_putc,"PEÄAKT\\POBATÜ");
                  break;
            }
            printEspacios(2);
            printVolver();
...
int CargarPunto(int *nPuntos,struct Punto *Curva){
   ...
   switch(config&0x03){
      case 0:
         printf(tft_putc,"PUNTO");
         break;
      case 1:
         printf(tft_putc,"POINT");
         break;
      case 2:
         printf(tft_putc,"POINT");
         break;
      case 3:
         printf(tft_putc,"TO×KA");
         break;
   }
   printf(tft_putc," %d:",*nPuntos);
...
int Soldando(int nPuntos, struct punto *Curva){
   ...
   for(int i=0; i<nPuntos; i++){
      ...
      while(EtapaEnCurso||TemperauraNoAlcanzada){
         ...
         if(ultimaTecla==_TICK && SoldandoEnPantalla==FALSE){ 
            ultimaTecla=_VISTO;
            return _Terminado;
         }
         if(prevCont!=Cont){
